...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Project_CuoiKy.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Project_CuoiKy.Properties.Resources.calendarDark;
                else calendarIcon = Project_CuoiKy.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
